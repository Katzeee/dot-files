...
brightness_slider:buttons(gears.table.join(
	...
	awful.button({}, 5, nil, function()
		if brightness_slider:get_value() < 1 then
			brightness_slider:set_value(1)
			return
		end
		brightness_slider:set_value(brightness_slider:get_value() - 5)
	end)
...
local update_slider = function()
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			...
			brightness_slider:set_value(tonumber(value) or
				error("Could not cast '" .. tostring(value) .. "' to number.'"))
