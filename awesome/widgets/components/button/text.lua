...
local twidget = require("widgets.components.text")
local ewidget = require("widgets.components.button.elevated")
...
local function button(args, type)
	...
	widget.text_animation = animation:new({
		...
		update = function(self, pos)
			text_widget:set_color(utils.color.rgb_to_hex(pos))
		end,
	})
...
function text_button.state(args)
	...
	args.text_hover_bg = args.text_hover_bg or utils.color.button_color(args.text_normal_bg, 0.1)
	args.text_press_bg = args.text_press_bg or utils.color.button_color(args.text_normal_bg, 0.2)

	args.text_on_normal_bg = args.text_on_normal_bg or args.text_normal_bg
	args.text_on_hover_bg = args.text_on_hover_bg or utils.color.button_color(args.text_on_normal_bg, 0.1)
	args.text_on_press_bg = args.text_on_press_bg or utils.color.button_color(args.text_on_normal_bg, 0.2)
