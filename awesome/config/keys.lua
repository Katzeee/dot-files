...
local GLOBAL_GROUPS = {
    awesome = {
        [mods.m] = {
            [""] = {
                { key = "/", action = hotkeys_popup.show_help, description = "show help" },
            },
            [mods.s] = {
            ...
            [""] = {
                {
                    ...
                    description = "focus down by direction",
                }
                ,
                {
                    key = "k",
                    ...
                    description = "focus up by direction",
                }
                ,
                {
                    key = "h",
                    ...
                    description = "focus left by direction",
                }
                ,
                {
                    key = "l",
                    ...
                    description = "focus right by direction",
                    group = "client"
                },
