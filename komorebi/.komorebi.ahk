...
; Open Yasb
Run, py -3.9 D:\github-codes\yasb-xac\src\main.py, , Hide
...
Run, komorebic.exe float-rule title Qv2ray, , Hide
...
Run, komorebic.exe identify-tray-application exe uTools.exe, , Hide
Run, komorebic.exe identify-tray-application exe qv2ray.exe, , Hide
